...
#define ZCL_ATTR_BASIC_BRIDGE_BACKLIGHT           0xff0B
#define ZCL_ATTR_BASIC_BRIDGE_BRIGHTNESS          0xff0C
...
#define ZCL_ATTR_BASIC_TEST_NET_STATUS            0xff15
...
#define ZCL_ATTR_ONOFF_CONFIGURATION_SWITCH_MULTI_CLICK        0xff06
